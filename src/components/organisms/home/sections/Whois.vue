<template>
  <!-- Whois? -->
  <section
    class="carousel slide testimonials-slider cid-sbF1IXXjdp"
    data-interval="false"
    id="testimonials1-4"
  >
    <div
      class="mbr-overlay"
      style="opacity: 0.7; background-color: rgb(35, 35, 35);"
    ></div>
        ...
        <div class="col-md-10">
          ...
          <div class="carousel-controls">
            ...
            >
              <span
                aria-hidden="true"
                class="mbri-arrow-prev mbr-iconfont"
              ></span>
            ...
            >
              <span
                aria-hidden="true"
                class="mbri-arrow-next mbr-iconfont"
              ></span>
