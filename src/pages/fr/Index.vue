...
import Page_Fr from '@/assets/content/home/fr.json'
...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      {
        property: "og:url",
        content: "https://luisventurae.github.io/",
      },
      {
        property: "og:image",
        content:
      ...
      },
      {
        ...
        content: process.env.GRIDSOME_GOOGLE_VERIFICATION,
      },
    ],
    link: [
      {
      ...
      },
      {
        rel: "alternate",
        hreflang: "fr",
        href: "https://luisventurae.github.io/fr/",
      },
    ],
  },
  components: {
